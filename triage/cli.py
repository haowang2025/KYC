...
def main(argv: list[str] | None = None):
    ...
    parser = argparse.ArgumentParser(
        description="triage — Merchant Risk Triage Agent",
        epilog="Examples:\n"
        '  python -m triage "Check Parsian Bank in Iran"\n'
        '  python -m triage "我们要接入一家迪拜的Golden Star Trading，20万美金的单子"\n'
        "  python -m triage --chat\n"
